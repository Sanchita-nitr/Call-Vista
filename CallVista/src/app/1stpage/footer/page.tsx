      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-[#fffae7] mb-6">
              Unlock powerful insights, streamline conversations, and deliver
              exceptional customer experiences with CallVista’s expert call
              analytics solutions.
            </p>
            ...
            <div className="flex items-center">
              ...
              <p className="text-[#fffae7'">info@callvista.com</p>
            </div>
          </div>
              ...
              >
                ...
                <ChevronUp
                  ...
                  className={`transition-transform ${
                    expanded.company ? "" : "transform rotate-180"
                  }`}
                />
              </div>
              <div
                className={`mt-4 space-y-3 ${
                  expanded.company ? "block" : "hidden"
                }`}
              >
                <p>
                  <a
                    href="#"
                    className="text-[#fff8dc] hover:text-[#fff8dc] transition-colors"
                  >
                    About Us
                  </a>
                </p>
            ...
            <div className="border-b border-sky-700 pb-2 mb-4">
              ...
              >
                ...
                <ChevronUp
                  size={18}
                  className={`transition-transform ${
                    expanded.support ? "" : "transform rotate-180"
                  }`}
                />
              </div>
              <div
                className={`mt-4 space-y-3 ${
                  expanded.support ? "block" : "hidden"
                }`}
              >
                <p>
                  <a
            ...
            <div className="border-b border-sky-700 pb-2 mb-4">
              ...
              >
                ...
                <ChevronUp
                  size={18}
                  className={`transition-transform ${
                    expanded.legal ? "" : "transform rotate-180"
                  }`}
                />
              </div>
              <div
                className={`mt-4 space-y-3 ${
                  expanded.legal ? "block" : "hidden"
                }`}
              >
                <p>
                  <a
          ...
          <div className="md:col-span-2 lg:col-span-1">
            ...
            <p className="text-[#fff8dc] mb-4">
              Stay updated with the latest insights, and exclusive Call Vista
              features.
            </p>
        ...
        <div className="border-t border-[#5e220c] mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-[#fff8dc] text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} Call Vista. All rights reserved.
          </p>
          <div className="flex space-x-4">
            <a
              href="#"
              className="text-[#5e220c] text-sm hover:text-[#fff8dc] transition-colors"
            >
              Terms
            </a>
            <a

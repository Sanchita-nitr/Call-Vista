'use client'
import { FiActivity, FiCheckCircle, FiClock, FiHeart, FiMessageSquare, FiMic, FiUsers, FiVolume2 } from 'react-icons/fi'; // Adjust the import path based on your icon library
...
const Features = () => {
    const stats = [
        ...
        { id: 4, value: 30, label: "Improved First Call Resolution", symbol: "%" }
      ];
    ...
    const features = [
        ...
        },
        {
          ...
          description: "Track and analyze hold durations to optimize customer waiting experience.",
        },
        {
          icon: <FiVolume2 className="h-10 w-10 text-[#8b3313]" />,
          title: "Dead Air Detection",
          description: "Identify awkward silences and gaps in conversation that may indicate confusion or issues.",
        },
        {
          icon: <FiActivity className="h-10 w-10 text-[#8b3313]" />,
          title: "Agent Overtalk",
          description: "Measure instances where agents talk over customers to improve conversation quality.",
        },
      ]
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="text-center mb-16">
      ...
      <p className="max-w-2xl mx-auto text-xl text-[#b53900]">
        A complete suite of tools to analyze, understand, and optimize your multilingual customer interactions
      </p>
    </div>
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
      {features.map((feature, index) => (
        <div key={index} className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-shadow group">
          ...
          <h3 className="text-xl font-bold text-[#a53502] mb-3">{feature.title}</h3>
    ...
    <div className=" mb-16 mt-16 bg-gradient-to-r from-[#fff8dc] to-indigo-50 rounded-2xl overflow-hidden shadow-lg">
      <div className="md:grid md:grid-cols-2">
        <div className="p-8 md:p-12 flex flex-col justify-center">
          ...
          <h3 className="text-2xl font-bold text-[#8b3313] mb-4">Multilingual Conversation Intelligence</h3>
          <p className="text-lg text-[#a53502] mb-6">
            Our platform uses specialized acoustic models trained on Indian speech patterns and accents to provide superior transcription accuracy for multiple Indian languages.
          </p>
          ...
          <div className="max-w-sm">
            <div className="bg-white bg-opacity-10 backdrop-filter backdrop-blur-sm rounded-xl p-6 border border-white border-opacity-20">
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h4 className="text-[#8b3313] font-bold text-lg">Language Detection</h4>
                  <p className="text-[#a53502] text-sm">Automatically identifies the spoken language</p>
                </div>
              </div>
              <div className="space-y-3">
                <div>
                  ...
                  <div className="w-full bg-white bg-opacity-20 rounded-full h-2">
                    <div className="bg-[#20b2aa] h-2 rounded-full" style={{ width: '85%' }}></div>
                  </div>
                </div>
                <div>
                  <div className="flex justify-between text-xs mb-1">
                  ...
                  <div className="w-full bg-white bg-opacity-20 rounded-full h-2">
                    <div className="bg-[#0000cd] h-2 rounded-full" style={{ width: '10%' }}></div>
                  </div>
                </div>
                <div>
                  <div className="flex justify-between text-xs mb-1">
                  ...
                  <div className="w-full bg-white bg-opacity-20 rounded-full h-2">
                    <div className="bg-[#f4a460] h-2 rounded-full" style={{ width: '5%' }}></div>
                  </div>
                </div>
              </div>
              <div className="mt-4 pt-4 border-t border-white border-opacity-20">
                <p className="text-[#a53502] text-sm mb-2">Code-switching detected</p>
  ...
  <div className="bg-[#fff8dc] py-10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <p className="text-center text-[#8b3313] text-sm font-semibold mb-6">TRUSTED BY INDUSTRY LEADERS</p>
            <div className="flex flex-wrap justify-center gap-x-12 gap-y-6">
              {integrations.map((partner, index) => (
                <div key={index} className="h-8">
                  <img src={partner.logo} alt={partner.name} className="h-full border object-contain" />
                </div>
              ))}
            </div>
          </div>
